...
export class DepartmentService {
  ...
  private REST_API_SERVER_DEPARTMENTS = "http://localhost:8085/departments";
  constructor(private httpClient: HttpClient) { }
  /**
   * Lấy danh sách các phòng ban từ API.
   * @returns Observable chứa kết quả từ việc lấy danh sách phòng ban.
   */
